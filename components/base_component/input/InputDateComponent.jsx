      ...
      >
        ...
        <div className='relative'>
          ...
          {icon && (
            <FontAwesomeIcon
              className={`
                absolute text-gray-400 left-1 ml-5 top-1/2 -translate-y-1/2
          ...
          {!disabled && (
            <label
              className='absolute top-1/2 -translate-y-1/2 mr-5 right-1 text-gray-400'
              onClick={() => setFocus(true)}>
              <FontAwesomeIcon
                className={`text-xl ${focus
                  ? !invalid
                    ? "text__primary"
                    : "text__danger"
                  : !invalid
